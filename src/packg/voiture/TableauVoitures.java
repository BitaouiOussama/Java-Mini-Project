...
public class TableauVoitures {
	...
	public TableauVoitures() {
		voiture[0] = new Voiture(1,"Ferrari","Portofino",2017,"Green",100000);
		voiture[1] = new Voiture(2,"Bugatti","Chiron",2020,"Black",4000000);
		voiture[2] = new Voiture(3,"Aston Martin","Valhalla",2022,"Gray",2000000);
		voiture[3] = new Voiture(4,"Alfa Romeo ","Quadrifoglio",2023,"Red",500000);
		voiture[4] = new Voiture(5,"BMW","I8",2022,"Orange",900000); 
	 }
